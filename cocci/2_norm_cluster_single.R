...
##### RENAME ABSEQ
# COCCI
new_names <- c("CD101", "CD10", "CD11b", "CD11c", "CD123-IL3RA", "CD14", "CD15-FUT4",)
...
# gc()
combinedRNA <- RunPCA(list[[1]], npcs = rnaPCs, verbose = FALSE)
...
combinedADT <- RunUMAP(list[[1]], reduction = "apca", reduction.name = "adt.umap", 
