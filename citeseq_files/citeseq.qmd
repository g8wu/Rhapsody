...
if (!file.exists(file.path(path_data, "5k_pbmc_protein_v3_filtered_feature_bc_matrix.tar.gz"))){
  ...
  url = "https://cf.10xgenomics.com/sam ples/cell-exp/3.0.2/5k_pbmc_protein_v3/5k_pbmc_protein_v3_raw_feature_bc_matrix.tar.gz"
...
```{r}
# chunk 7: create violon plots for QC
# try + vs & 
VlnPlot(object = obj,
...
markers_all <- read.csv("~/Research/Croker/marker_genes.csv")
