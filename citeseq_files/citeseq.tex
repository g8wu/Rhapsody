...
\includegraphics{https://drive.google.com/uc?export=view\&id=1tmTkjNa8BwQEyyL6Amab1XQFdl6uzCNS.pdf}

\textbf{\texttt{DATA\ FLOW}}

\includegraphics[width=19.44792in,height=\textheight]{https://drive.google.com/uc?export=view\&id=1r0UJXc4-Gp3431NVk7D-60Y1Qmft4F8D.pdf}

\includegraphics{https://drive.google.com/uc?export=view\&id=1h4pFQe6gM3k8LI6QsmZ4rFDHo9jimgo6.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# chunk 1: load libraries}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# chunk 2: download files from 10x website}
\CommentTok{\#| echo: false}
\CommentTok{\# recommended location for local data}
\CommentTok{\#dir.create("../data")}
\NormalTok{path\_data }\OtherTok{\textless{}{-}} \FunctionTok{file.path}\NormalTok{(}\StringTok{".."}\NormalTok{, }\StringTok{"data"}\NormalTok{)}
\FunctionTok{dir.create}\NormalTok{(path\_data, }\AttributeTok{showWarnings =} \ConstantTok{FALSE}\NormalTok{)}
...
\begin{verbatim}
[1] "C:/Users/ginny/OneDrive/Documents/Research/Croker"
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{path\_data}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\ControlFlowTok{if}\NormalTok{ (}\SpecialCharTok{!}\FunctionTok{file.exists}\NormalTok{(}\FunctionTok{file.path}\NormalTok{(path\_data, }\StringTok{"5k\_pbmc\_protein\_v3\_filtered\_feature\_bc\_matrix.tar.gz"}\NormalTok{)))\{}
  
  \CommentTok{\# download the raw feature matrix}
\NormalTok{  url }\OtherTok{=} \StringTok{"https://cf.10xgenomics.com/samples/cell{-}exp/3.0.2/5k\_pbmc\_protein\_v3/5k\_pbmc\_protein\_v3\_raw\_feature\_bc\_matrix.tar.gz"}
\NormalTok{dest }\OtherTok{=} \FunctionTok{file.path}\NormalTok{(path\_data, }\StringTok{"5k\_pbmc\_protein\_v3\_raw\_feature\_bc\_matrix.tar.gz"}\NormalTok{)}
\FunctionTok{download.file}\NormalTok{(url,      }\AttributeTok{destfile =}\NormalTok{ dest, }\AttributeTok{method =} \StringTok{"auto"}\NormalTok{)}

  \CommentTok{\# download the filtered feature matrix}
  \CommentTok{\# this is after 10x cell ranger filters for barcodes }
  \CommentTok{\# barcodes that do not correspond to cells {-} barcode read errors etc}
\NormalTok{  url }\OtherTok{=} \StringTok{"https://cf.10xgenomics.com/samples/cell{-}exp/3.0.2/5k\_pbmc\_protein\_v3/5k\_pbmc\_protein\_v3\_filtered\_feature\_bc\_matrix.tar.gz"}
\NormalTok{  dest }\OtherTok{=} \FunctionTok{file.path}\NormalTok{(path\_data, }\StringTok{"5k\_pbmc\_protein\_v3\_filtered\_feature\_bc\_matrix.tar.gz"}\NormalTok{)}
  \FunctionTok{download.file}\NormalTok{(url, }\AttributeTok{destfile =}\NormalTok{ dest, }\AttributeTok{method =} \StringTok{"auto"}\NormalTok{)}


\CommentTok{\# download the metrics summary}
\NormalTok{  url }\OtherTok{=} \StringTok{"https://cf.10xgenomics.com/samples/cell{-}exp/3.0.2/5k\_pbmc\_protein\_v3/5k\_pbmc\_protein\_v3\_metrics\_summary.csv"}
\NormalTok{  dest }\OtherTok{=} \FunctionTok{file.path}\NormalTok{(path\_data, }\StringTok{"5k\_pbmc\_protein\_v3\_metrics\_summary.csv"}\NormalTok{)}
  \FunctionTok{download.file}\NormalTok{(url, }\AttributeTok{destfile =}\NormalTok{ dest, }\AttributeTok{method =} \StringTok{"auto"}\NormalTok{)}


\CommentTok{\# download the summary html (optional)}
\NormalTok{  url }\OtherTok{=} \StringTok{"https://cf.10xgenomics.com/samples/cell{-}exp/3.0.2/5k\_pbmc\_protein\_v3/5k\_pbmc\_protein\_v3\_web\_summary.html"}
\NormalTok{  dest }\OtherTok{=} \FunctionTok{file.path}\NormalTok{(path\_data, }\StringTok{"5k\_pbmc\_protein\_v3\_web\_summary.html"}\NormalTok{)}
  \FunctionTok{download.file}\NormalTok{(url, }\AttributeTok{destfile =}\NormalTok{ dest, }\AttributeTok{method =} \StringTok{"auto"}\NormalTok{)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# chunk 3: Extract the data using untar in R}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# chunk 4: load the data (change the file path as needed)}
...
\FunctionTok{VlnPlot}\NormalTok{(obj, }\AttributeTok{features =} \FunctionTok{c}\NormalTok{(}\StringTok{"nFeature\_RNA"}\NormalTok{, }\StringTok{"nCount\_RNA"}\NormalTok{, }\StringTok{"percent.mt"}\NormalTok{), }\AttributeTok{ncol =} \DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{figure}[H]

{\centering \includegraphics{citeseq_files/figure-pdf/unnamed-chunk-4-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# chunk 5: explore what is in each of the three files Seurat wants to read}
\NormalTok{file}\OtherTok{=}\FunctionTok{file.path}\NormalTok{(path\_data, }\StringTok{"tenx\_pbmc5k\_CITEseq"}\NormalTok{, }\StringTok{"filtered\_feature\_bc\_matrix"}\NormalTok{, }\StringTok{"barcodes.tsv.gz"}\NormalTok{)}
\NormalTok{barcodesData}\OtherTok{=}\FunctionTok{read.csv}\NormalTok{(file)}
\FunctionTok{dim}\NormalTok{(barcodesData)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{head}\NormalTok{(barcodesData)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
  AAACCCAAGAGACAAG.1
1 AAACCCAAGGCCTAGA-1
2 AAACCCAGTCGTGCCA-1
3 AAACCCATCGTGCATA-1
4 AAACGAAAGACAAGCC-1
5 AAACGAAAGAGTGACC-1
6 AAACGAACATGCCATA-1
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{file}\OtherTok{=}\FunctionTok{file.path}\NormalTok{(path\_data, }\StringTok{"tenx\_pbmc5k\_CITEseq"}\NormalTok{, }\StringTok{"filtered\_feature\_bc\_matrix"}\NormalTok{, }\StringTok{"features.tsv.gz"}\NormalTok{)}
\NormalTok{featuresData}\OtherTok{=}\FunctionTok{read.csv}\NormalTok{(file)}
\FunctionTok{dim}\NormalTok{(featuresData)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{head}\NormalTok{(featuresData)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{file}\OtherTok{=}\FunctionTok{file.path}\NormalTok{(path\_data, }\StringTok{"tenx\_pbmc5k\_CITEseq"}\NormalTok{, }\StringTok{"filtered\_feature\_bc\_matrix"}\NormalTok{, }\StringTok{"matrix.mtx.gz"}\NormalTok{)}
\NormalTok{matrixData}\OtherTok{=}\FunctionTok{read.csv}\NormalTok{(file)}
\FunctionTok{dim}\NormalTok{(matrixData)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{head}\NormalTok{(matrixData)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
                                   X..MatrixMarket.matrix.coordinate.integer.general
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# chunk 6: read in the summary table}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# chunk 7: create violon plots for QC}
\CommentTok{\# try + vs \& }
...
{\centering \includegraphics{citeseq_files/figure-pdf/unnamed-chunk-7-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# chunk 8: remove cells with certain issues {-} adjust cutoffs as desired}
...
{\centering \includegraphics{citeseq_files/figure-pdf/unnamed-chunk-8-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# chunk 9: Seurat data transformation and normalization }
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# chunk 10: dimensionality reduction using PCA}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# chunk 11: plot the variance explained by addition of each PCA component }
\CommentTok{\# to determine the no of PCs to use for downstream analysis}
...
{\centering \includegraphics{citeseq_files/figure-pdf/unnamed-chunk-11-1.pdf}
...
\CommentTok{\#LabelPoints(plot = VariableFeaturePlot(object = obj),}
\CommentTok{\#            points = head(VariableFeatures(object = obj), 20),}
\CommentTok{\#            repel = TRUE, xnudge = 0, ynudge = 0)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# chunk 12: Computing shared nearest neighbor graph}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# https://www.rdocumentation.org/packages/Seurat/versions/3.0.1/topics/FindNeighbors}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# chunk 13: clustering (adjust dimensions and resolutions as desired)}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# https://www.rdocumentation.org/packages/Seurat/versions/1.4.0/topics/FindClusters}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# chunk 14: the famous UMAP}
...
\begin{verbatim}
14:10:03 UMAP embedding parameters a = 0.9922 b = 1.112
\end{verbatim}

\begin{verbatim}
14:10:03 Read 4193 rows and found 20 numeric columns
\end{verbatim}

\begin{verbatim}
14:10:03 Using Annoy for neighbor search, n_neighbors = 30
\end{verbatim}

\begin{verbatim}
14:10:03 Building Annoy index with metric = cosine, n_trees = 50
\end{verbatim}
...
\begin{verbatim}
**************************************************|
14:10:04 Writing NN index file to temp file C:\Users\ginny\AppData\Local\Temp\Rtmpq8aPMJ\filead054c57fd7
14:10:04 Searching Annoy index using 1 thread, search_k = 3000
14:10:06 Annoy recall = 100%
14:11:05 Commencing smooth kNN distance calibration using 1 thread with target n_neighbors = 30
14:11:09 Initializing from normalized Laplacian + noise (using irlba)
14:11:10 Commencing optimization for 500 epochs, with 174318 positive edges
14:11:26 Optimization finished
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# https://www.rdocumentation.org/packages/Seurat/versions/2.3.4/topics/RunUMAP}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# chunk 15: you can also use the LabelClusters function to help label individual clusters}
...
{\centering \includegraphics{citeseq_files/figure-pdf/unnamed-chunk-15-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# chunk 16: some MANUAL work {-} sort by Cell\_Type and Marker if not already sorted}
\NormalTok{markers\_all }\OtherTok{\textless{}{-}} \FunctionTok{read.csv}\NormalTok{(}\StringTok{"\textasciitilde{}/Research/Croker/marker\_genes.csv"}\NormalTok{)}
...
\NormalTok{select\_markers }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"CCR7"}\NormalTok{, }\StringTok{"CD19"}\NormalTok{, }\StringTok{"CD22"}\NormalTok{, }\StringTok{"CD31"}\NormalTok{, }\StringTok{"COL1A2"}\NormalTok{, }\StringTok{"DCN"}\NormalTok{, }\StringTok{"KRT1"}\NormalTok{, }\StringTok{"KRT5"}\NormalTok{, }\StringTok{"CD14"}\NormalTok{, }\StringTok{"MS4A7"}\NormalTok{, }\StringTok{"LYZ"}\NormalTok{, }\StringTok{"PMEL"}\NormalTok{, }\StringTok{"GNLY"}\NormalTok{, }\StringTok{"GZMA"}\NormalTok{, }\StringTok{"IRF7"}\NormalTok{, }\StringTok{"IRF8"}\NormalTok{, }\StringTok{"JCHAIN"}\NormalTok{, }\StringTok{"CD3D"}\NormalTok{, }\StringTok{"CD4"}\NormalTok{, }\StringTok{"CD8A"}\NormalTok{, }\StringTok{"IL7R"}\NormalTok{ )}
...
\NormalTok{                          dplyr}\SpecialCharTok{::}\FunctionTok{filter}\NormalTok{(Cell\_Type }\SpecialCharTok{\%in\%}\NormalTok{ select\_cell\_types) }\SpecialCharTok{\%\textgreater{}\%}
                          \CommentTok{\#dplyr::filter(Marker \%in\% select\_markers) \%\textgreater{}\%}
...
{\centering \includegraphics{citeseq_files/figure-pdf/unnamed-chunk-17-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# chunk 18: make a dot plot for clusters using ADT data}
...
{\centering \includegraphics{citeseq_files/figure-pdf/unnamed-chunk-18-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# chunk 19: reset the default assay back to RNA!!}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# chunk 20: feature plots }
...
{\centering \includegraphics{citeseq_files/figure-pdf/unnamed-chunk-20-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# chunk 21: violin plots}
\FunctionTok{VlnPlot}\NormalTok{(}\AttributeTok{object =}\NormalTok{ obj,}
...
{\centering \includegraphics{citeseq_files/figure-pdf/unnamed-chunk-21-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# chunk 22: name clusters }
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# chunk 23: overlay ADT information on top of feature plots to find B cells}
...
{\centering \includegraphics{citeseq_files/figure-pdf/unnamed-chunk-23-1.pdf}
